...
function AlertDialogHeader({ className, ...props }: React.ComponentProps<'div'>) {
    return <div data-slot="alert-dialog-header" className={cn('flex p-4 flex-col gap-2 text-center sm:text-left', className)} {...props} />;
}
...
function AlertDialogFooter({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn('flex flex-col-reverse gap-2 sm:flex-row sm:justify-end bg-muted/50 p-4 border-t', className)}
            {...props}
        />
    );
}
