...
import { Eye, Folder, ImageIcon, Layers3, Medal, TrendingUp, TrendingDown, Lock, Calendar1, Funnel, Info, Trash2, RefreshCw } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-end">
                <div className="flex gap-2 justify-between w-full">
                    ...
                    <div className="flex gap-2">
                        <Button variant="outline" className="h-full group" onClick={() => router.refresh()}>
